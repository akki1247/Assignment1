...
!(function() {
  ...
  var o,
    ...
    l = {
      ...
      widget: function(e) {
        ...
        }), e.cme && (this.options.customer = "cme"), isFinite(
          e.widgetbar_width
        ) &&
          e.widgetbar_width > 0 &&
          (this.options.widgetbar_width =
            e.widgetbar_width), (this._ready_handlers = []), this.create();
      },
      chart: function(e) {
  ...
  (l.WidgetAbstract.prototype = {
    ...
    addWrapperFrame: function(e) {
      ...
      return (t.id = this.id + "-wrapper"), (t.style.cssText =
        "position: relative;box-sizing: content-box;margin: 0 auto !important;padding: 0 !important;font-family: " +
        d +
        ";"), (t.style.width = l.WidgetAbstract.prototype.width.call(
        this
      )), (t.style.height = l.WidgetAbstract.prototype.height.call(
        this
      )), t.appendChild(e), t;
    }
    ...
    render: function() {
      ...
      }), (this.options.type = "events"), l.addUrlParams(
        e,
      ...
      return (t.title = l.getWidgetTitleAttribute(
        ...
        this.options.iframeLang || "en"), (t.width = this.options.width), this
        .options.height && (t.height = this.options.height), t.setAttribute(
        "frameBorder",
        "0"
      ), t.setAttribute("scrolling", "no"), (t.src = e), t;
    }
    ...
    render: function() {
      ...
      (e["page-uri"] = l.getPageUriString()), (this.options.type =
        "symbol-overview");
      ...
      this.options.customer && (i.pathname += this.options.customer + "/"), this
        .options.locale &&
      ...
      return (r.title = l.getWidgetTitleAttribute(
        ...
        this.options.iframeLang || "en"), (r.id = this.id), (r.style.cssText =
        "margin: 0 !important;padding: 0 !important;"), this.options.width &&
        (r.style.width = this.options.width), this.options.height &&
        (r.style.height = this.options.height), r.setAttribute(
        "frameBorder",
        "0"
      ), r.setAttribute("allowTransparency", "true"), r.setAttribute(
        "scrolling",
        "no"
      ), (r.src = i.href), r;
    },
    ...
    create: function() {
      (this.options.type = this.options.fundamental
        ? "fundamental"
        : "chart"), (this.iframe = this.render());
      var e = this;
      let t = this.iframe;
      this.options.noLogoOverlay ||
        (t = l.WidgetAbstract.prototype.addWrapperFrame.call(this, t)), c(
        t,
        this.options
      );
    ...
    render: function() {
      ...
      return (e.title = l.getWidgetTitleAttribute(
        ...
        this.options.iframeLang || "en"), (e.id = this.id), (e.style.cssText =
        "width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"), e.setAttribute(
        "frameBorder",
        "0"
      ), e.setAttribute("allowTransparency", "true"), e.setAttribute(
        "scrolling",
        "no"
      ), e.setAttribute(
        "allowfullscreen",
        "true"
      ), (e.src = this.generateUrl()), e;
    },
    generateUrl: function(e) {
      var t;
      function o(e, t, o) {
        let i = h(t, o);
        "object" == typeof i && (i = JSON.stringify(i)), void 0 !== i &&
          "" !== i &&
          (a[e] = i);
      }
      function i(e, t, i) {
      ...
      t =
        "cme" === (e = e || this.options).customer
          ? "/cmewidgetembed/"
          : e.customer ? "/" + e.customer + "/widgetembed/" : "/widgetembed/";
      var r = l.getHost(e);
      const n = new URL(r + t);
      n.searchParams.append("hideideas", "1"), n.searchParams.append(
        "overrides",
      ...
      return (a.symbol = e.symbol), (a.frameElementId = this.id), (a.interval =
        e.interval), o("range", e.range), i(
        "hide_top_toolbar",
        e.hide_top_toolbar
      ), i("hide_legend", e.hide_legend), i(
        "hide_side_toolbar",
        e.hide_side_toolbar,
        "0"
      ), i("allow_symbol_change", e.allow_symbol_change, "0"), i(
        "save_image",
        e.save_image,
        "0"
      ), i("doNotStoreSettings", e.doNotStoreSettings), o(
        "backgroundColor",
        e.backgroundColor
      ), o("gridColor", e.gridColor), e.watchlist &&
        e.watchlist.length &&
        e.watchlist.join &&
        o("watchlist", e.watchlist.join("")), e.compareSymbols &&
        e.compareSymbols.length &&
        o("compareSymbols", e.compareSymbols), i(
        "editablewatchlist",
        e.editablewatchlist
      ), i("details", e.details), i("calendar", e.calendar), i(
        "hotlist",
        e.hotlist
      ), e.studies &&
        l.isArray(e.studies) &&
        ("string" == typeof e.studies[0]
          ...
          : o("studies", e.studies)), i(
        "horztouchdrag",
        e.horztouchdrag,
        "0"
      ), i("verttouchdrag", e.verttouchdrag, "0"), o(
        "widgetbar_width",
        e.widgetbar_width
      ), o("theme", e.theme), o("style", e.style), o(
        "extended_hours",
        e.extended_hours
      ), o("timezone", e.timezone), i("hideideasbutton", e.hideideasbutton), i(
        "withdateranges",
        e.withdateranges
      ), i("hide_volume", e.hide_volume), o("padding", e.padding), i(
        "show_popup_button",
        e.show_popup_button
      ), o("padding", e.padding), o(
        "studies_overrides",
        e.studies_overrides,
        {}
      ), o("publish_source", e.publish_source), o("venue", e.venue), o(
        "symbology",
        e.symbology
      ), o("whotrades", e.whotrades), o("referral_id", e.referral_id), i(
        "no_referral_id",
        e.no_referral_id
      ), o("fundamental", e.fundamental), o("percentage", e.percentage), o(
        "utm_source",
        window.location.hostname
      ), o(
        "utm_medium",
        l.hasCopyright(e.container) ? "widget_new" : "widget"
      ), o("utm_campaign", e.type), r !== l.host &&
        o("supportHost", l.host), e.type &&
        "chart" === e.type &&
        o("utm_term", e.symbol), o(
        "page-uri",
        l.getPageUriString()
    ...
    create: function() {
      ...
      var o,
        i = this;
      c(t, this.options), (o = document.getElementById(
        this.id
        ...
        if (
          ...
          for (
            var t = document.getElementsByTagName("a"),
              ...
              n = new RegExp("/chart/([0-9a-zA-Z:+*-/()]+)/" + i.options.chart),
              a = 0;
            a < t.length;
            a++
          )
    ...
    render: function() {
      ...
      l.addUrlParams(
        ...
        !0
      ), (this.options.type = "chart"), l.addUrlParams(
        e,
        l.generateUtmForUrlParams(this.options)
      );
      const t = document.createElement("iframe");
      return (t.title = l.getWidgetTitleAttribute(
        ...
        this.options.iframeLang || "en"), (t.id = this.id), (t.style.cssText =
        "width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;"), t.setAttribute(
        "frameBorder",
        "0"
      ), t.setAttribute("allowTransparency", "true"), t.setAttribute(
        "scrolling",
        "no"
      ), t.setAttribute("allowfullscreen", "true"), (t.src = e.href), t;
    },
      ...
      if (i) {
        ...
        if (r) {
          ...
          if (n)
            try {
              const e = new URL(n);
              l.addUrlParams(e, l.generateUtmForUrlParams(t)), r.setAttribute(
                "href",
                e.toString()
              );
            } catch (e) {
